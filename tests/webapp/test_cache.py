...
class _FakeDashboard:
    ...
    def simuliere(self, *, monate: int) -> None:
...
def ladezaehler(monkeypatch):
    ...
    async def _fake_laden_async(*, stichtag=None, horizont_monate=3, auslastung_monate=12):
...
def test_anstossen_meldet_einen_fehlgeschlagenen_ladevorgang_statt_ihn_zu_verlieren(
    ...
    async def _schlaegt_fehl(*, stichtag=None, horizont_monate=3, auslastung_monate=12):
